...
$(document).ready(function(){
	...
	$(document).ready(function(){
	    ...
	    $("#Experience").focusout(function(){
	        ...
	        document.getElementById("tot").value=months.toFixed(1);
 ...
 <body>
        ...
        <g:form  Id="myform" controller="Employee" action="change">
  
  	<fieldset>
   <legend><h1>UpdateRegistration</h1></legend><br>
...
<tr id="Experience1">
						...
						<td><input type="text" id="tot" name="tot" value="" /><br></td>
...
<tr>
<td>EmpId: </td>
 <td><input type="text" Id="emp" name="empId"/></td>
</tr>
<tr>
...
<td>CreatedDate: </td> <td><input type="date" Id="date" name="createdDate" required="" data-msg-required="please select createdate"/><br/></td>
            ...
            <input type="Submit" Id="btnsave" value="Update" style="font-size:15px"/>
